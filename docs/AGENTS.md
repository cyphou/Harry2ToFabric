# Multi-Agent Architecture — Harry Potter Dataset to Vector Embeddings Migration
...
| **@extractor** | Parsing Harry Potter Dataset source artifacts | `src/` extraction modules |
...
```
        ...
        │(Harry Potter Dataset parse)│  │ (coord.)  │   │ (coord.)   │
        └──────┬─────┘   └─────┬─────┘   └─────┬──────┘
               │          ┌────┴────┐     ┌─────┴──────┐
               │          │         │     │            │
               │     ┌────▼───┐ ┌───▼───┐ ┌▼────────┐ ┌▼──────┐
...
| **Formula Correctness** | Valid syntax, correct conversion from Harry Potter Dataset formulas |
