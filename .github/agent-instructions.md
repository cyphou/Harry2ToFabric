# Agent Behavior Instructions — Harry Potter Dataset to Vector Embeddings Migration
...
- **Pipeline**: Harry Potter Dataset → Vector Embeddings
- **Source**: `src/`
- **Target**: (output)
- **Tests**: `pytest tests/ --tb=short -q` — 4 test files
