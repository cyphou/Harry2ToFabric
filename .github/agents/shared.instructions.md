---
description: "Shared rules for all agents in the Harry Potter Dataset to Vector Embeddings migration project. USE FOR: enforcing project-wide constraints, coding standards, and safety rules."
---

# Shared Project Rules — Harry Potter Dataset to Vector Embeddings Migration
...
```
Harry Potter Dataset → Vector Embeddings
```
