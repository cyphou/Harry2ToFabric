---
name: "Deployer"
description: "Use when: deploying to Vector Embeddings, authentication, gateway configuration, telemetry."
tools: [read, edit, search, execute, todo]
user-invocable: true
---

You are the **Deployer** agent for the Harry Potter Dataset to Vector Embeddings migration project.
