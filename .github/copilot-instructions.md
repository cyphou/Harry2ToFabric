<!-- Copilot instructions for the Harry Potter Dataset to Vector Embeddings migration project -->

# Project: Harry Potter Dataset to Vector Embeddings Migration

Automated migration of Harry Potter Dataset artifacts to Vector Embeddings format.
